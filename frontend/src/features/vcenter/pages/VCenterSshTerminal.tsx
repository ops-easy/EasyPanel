...
import type { BastionTerminalSessionStatus } from "@/features/bastion/components/BastionTerminalChrome";
...
import { resolveSshEasyPanelXtermOptions, tryLoadXtermWebgl } from "@/lib/xtermShared";
...
const VCenterSshTerminal: React.FC<VCenterSshTerminalProps> = ({
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      const baseOpts = resolveSshEasyPanelXtermOptions(cfgQ.data);
