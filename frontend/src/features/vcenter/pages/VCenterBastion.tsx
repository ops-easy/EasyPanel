...
import BastionHostInsightPanel from "@/features/bastion/components/BastionHostInsightPanel";
import BastionTerminalChrome, {
  bastionTabStatusDotClass,
  type BastionTerminalSessionStatus,
} from "@/features/bastion/components/BastionTerminalChrome";
      ...
      <header className="flex h-10 shrink-0 items-center justify-between gap-2 border-b border-[#1f1f1f] bg-black px-3">
        ...
        <div className="flex shrink-0 items-center gap-0.5">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/cluster/compute/config" title="虚拟机全局 SSH 设置">全局 SSH</Link>
          </Button>
          {selectedVm ? (
            <Button
              type="button"
