              ...
              <>
                <div className="flex flex-wrap gap-2">
                  <ConfirmActionButton
                    ...
                    title="确认应用 ConfigMap YAML？"
                    description={`将把 ConfigMap ${namespace}/${configMapName} 的 YAML 写入 Kubernetes API。`}
                    confirmLabel="应用"
        ...
        <DialogContent className="flex max-h-[90vh] w-full max-w-[calc(100%-2rem)] flex-col gap-3 overflow-y-auto sm:max-w-7xl">
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            ...
            <ConfirmActionButton
              ...
              disabled={applyMut.isPending}
              title="确认应用 ConfigMap YAML？"
              description={`将把 ConfigMap ${namespace}/${configMapName} 的当前 YAML 写入 Kubernetes API。`}
              confirmLabel="应用"
