...
func structuredRuntimeFieldMappings() []structuredRuntimeMapping {
	return []structuredRuntimeMapping{
		...
		{key: "ingressNginxNamespace", paths: [][]string{{"ingress", "nginxNamespace"}, {"k8sAddons", "ingressNginx", "namespace"}}},
		...
		{key: "kubePrometheusStackNamespace", paths: [][]string{{"k8sAddons", "kubePrometheusStack", "namespace"}}},
		{key: "kubePrometheusStackReleaseName", paths: [][]string{{"k8sAddons", "kubePrometheusStack", "releaseName"}}},
		{key: "victoriaLogsNamespace", paths: [][]string{{"victoriaLogs", "namespace"}, {"k8sAddons", "victoriaLogs", "namespace"}}},
		{key: "victoriaLogsReleaseName", paths: [][]string{{"victoriaLogs", "releaseName"}, {"k8sAddons", "victoriaLogs", "releaseName"}}},
		{key: "metricsServerNamespace", paths: [][]string{{"k8sAddons", "metricsServer", "namespace"}}},
		{key: "kubernetesDashboardNamespace", paths: [][]string{{"k8sAddons", "kubernetesDashboard", "namespace"}}},
		{key: "kubernetesDashboardReleaseName", paths: [][]string{{"k8sAddons", "kubernetesDashboard", "releaseName"}}},
