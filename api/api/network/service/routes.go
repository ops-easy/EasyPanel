...
func RegisterRoutes(api *gin.RouterGroup, app *appctx.ServerApp) {
	...
	g.GET("/devices/:id/interfaces", func(c *gin.Context) { handleNetworkDeviceGenericEmpty(c, app, "interfaces") })
	g.GET("/devices/:id/clients", func(c *gin.Context) { handleNetworkDeviceGenericEmpty(c, app, "clients") })
	g.GET("/devices/:id/traffic", func(c *gin.Context) { handleNetworkDeviceGenericEmpty(c, app, "traffic") })
