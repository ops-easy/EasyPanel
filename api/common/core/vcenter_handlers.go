...
func registerVCenterRoutes(api *gin.RouterGroup, app *ServerApp) {
	...
	api.GET("/bastion/targets", func(c *gin.Context) { handleGetBastionTargets(c, app) })
	api.GET("/bastion/targets/ssh-settings", func(c *gin.Context) { handleGetBastionTargetSSHSettings(c, app) })
	api.PUT("/bastion/targets/ssh-settings", func(c *gin.Context) { handlePutBastionTargetSSHSettings(c, app) })
	api.DELETE("/bastion/targets/ssh-settings", func(c *gin.Context) { handleDeleteBastionTargetSSHSettings(c, app) })
	api.GET("/bastion/ssh/ws", func(c *gin.Context) { handleBastionTargetSSHWS(c, app) })
	api.GET("/bastion/sftp/ws", func(c *gin.Context) { handleBastionTargetSFTPWS(c, app) })
